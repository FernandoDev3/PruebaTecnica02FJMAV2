...
namespace PruebaTecnica02FJMAV2.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(PruebaTecnica02FJMAV2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Marcas != null ? 
                          ...
                          Problem("Entity set 'PruebaTecnica02FJMAV2Context.Marcas'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MarcaId,Nombre")] Marca marca)
        {
            if (id != marca.MarcaId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PruebaTecnica02FJMAV2Context.Marcas'  is null.");
            }
            var marca = await _context.Marcas.FindAsync(id);
            if (marca != null)
            {
